...
source_image_path = f"./images/xuoc_{i}.jpg"

opt = {

    "weights": "last_sang.pt",  # Path to weights file default weights are for nano model
    "yaml": "mydataset.yaml",
...
cv2.imshow("Hinh anh sau khi kiem tra", img0)
cv2.waitKey(0)
